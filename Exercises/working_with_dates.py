...
date1 = datetime.strptime("07-05-2025", "%d-%m-%Y")
print(date1)
#"May 7, 2025 2:30 PM" to a datetime object
date2 = datetime.strptime("May 7, 2025 2:30 PM", "%B %d, %Y %I:%M %p")
print(date2)
#"2025/05/07 14:30:00" using %Y/%m/%d %H:%M:%S
date3 = datetime.strptime("2025/05/07 14:30:00", "%Y/%m/%d %H:%M:%S" )
print(date3)
...
def max_time(iso_str1, iso_str2):
    date1 = datetime.fromisoformat(iso_str1)
    date2 = datetime.fromisoformat(iso_str2)
